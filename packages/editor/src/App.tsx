  ...
  return (
    <div className="min-h-screen bg-[#0b0b0c] text-zinc-100">
      ...
      <main className="flex flex-col lg:flex-row">
        <ToolRail tool={tool} onChange={setTool} shortcuts={shortcuts} />
