...
describe('panel resizing', () => {
  ...
  it('reorders utility tabs and keeps floating headers recoverable', () => {
    expect(reorderUtilityPanels(['layers', 'channels', 'paths', 'history', 'actions', 'navigator', 'histogram', 'swatches', 'gradients', 'patterns', 'libraries', 'plugins', 'info'], 'info', 'history')).toEqual(['layers', 'channels', 'paths', 'info', 'history', 'actions', 'navigator', 'histogram', 'swatches', 'gradients', 'patterns', 'libraries', 'plugins'])
