...
describe('panel resizing', () => {
  ...
  it('reorders utility tabs and keeps floating headers recoverable', () => {
    expect(reorderUtilityPanels(['layers', 'history', 'navigator', 'histogram', 'swatches', 'gradients', 'info'], 'info', 'history')).toEqual(['layers', 'info', 'history', 'navigator', 'histogram', 'swatches', 'gradients'])
