...
export const psdCompatibility: readonly PsdCompatibilityEntry[] = [
  ...
  entry('advanced-blending', 'Blend If, fill opacity, knockout, and channel restrictions', 'partial', 'partial', 'Blend If, fill opacity, knockout, transparency-shapes-layer, interior-effect grouping, and channel restrictions round-trip on layers and groups; settings without a Studio compositor implementation are reported as preserved but not previewed.', 'packages/editor/src/editor/psd.test.ts'),
