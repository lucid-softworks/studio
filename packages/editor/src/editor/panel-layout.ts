...
export type UtilityPanelId = 'layers' | 'history' | 'navigator' | 'histogram' | 'swatches' | 'gradients' | 'patterns' | 'libraries' | 'info'
...
export const defaultWorkspaceLayout: WorkspaceLayout = {
  ...
  utilityPanelOrder: ['layers', 'history', 'navigator', 'histogram', 'swatches', 'gradients', 'patterns', 'libraries', 'info'],
...
export const builtInWorkspacePresets: readonly WorkspacePreset[] = [
  { name: 'Essentials', builtIn: true, layout: defaultWorkspaceLayout },
  {
    ...
    layout: {
      ...
      utilityPanelOrder: ['navigator', 'histogram', 'swatches', 'gradients', 'patterns', 'libraries', 'layers', 'history', 'info'],
      utilityPanelFloating: false,
      floatingPanelPosition: { x: 960, y: 84 },
    },
  },
...
export function normalizeWorkspaceLayout(value: unknown, fallback = defaultWorkspaceLayout): WorkspaceLayout {
  ...
  const utilityPanels: UtilityPanelId[] = ['layers', 'history', 'navigator', 'histogram', 'swatches', 'gradients', 'patterns', 'libraries', 'info']
