...
export const studioToolParity: Record<EditorTool, ParityAssessment> = {
  ...
  'magic-wand': partial('Needs contiguous/global controls, sample modes, anti-alias parity, and worker cancellation/reference fixtures.'),
  'object-select': partial('Needs stronger non-AI foreground extraction, region modes, and worker cancellation/reference fixtures.', 'visually-inaccurate'),
