...
export const studioToolParity: Record<EditorTool, ParityAssessment> = {
  ...
  'magic-wand': partial('Needs contiguous/global controls, sample modes, anti-alias parity, and lower commit latency.', 'too-slow'),
  'object-select': partial('Needs stronger non-AI foreground extraction, region modes, and lower commit latency.', 'visually-inaccurate', 'too-slow'),
  ...
  fill: partial('Needs contiguous/global modes, sample-all-layers, anti-alias parity, and incremental execution.', 'too-slow'),
